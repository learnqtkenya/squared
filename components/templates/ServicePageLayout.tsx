  ...
  return (
    <section className="pt-32 pb-20 px-4 bg-gradient-to-br from-white via-emerald-50/30 to-white dark:from-gray-900 dark:via-emerald-950/20 dark:to-gray-900 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        <AnimatedSection>
          <Link href="/" className="inline-flex items-center gap-2 text-primary dark:text-emerald-500 mb-8 hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors font-medium">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <AnimatedSection delay={0.4}>
            <div className="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-xl border border-primary/20200 dark:border-primary/20900 hover:shadow-2xl transition-shadow duration-500">
              ...
              <div className="space-y-4">
                {capabilities.map((capability, idx) => (
                  ...
                  >
                    <div className="w-2 h-2 bg-primary dark:bg-emerald-500 rounded-full group-hover:scale-150 transition-transform"></div>
                    <span className="text-gray-700 dark:text-gray-300 group-hover:text-primary dark:group-hover:text-emerald-500 transition-colors">
                      {capability}
                    </span>
                  </motion.div>
                ))}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, idx) => (
            <AnimatedCard key={idx} delay={idx * 0.1}>
              <div className="group h-full bg-gradient-to-br from-white to-emerald-50/50 dark:from-gray-800 dark:to-emerald-950/20 p-8 rounded-2xl border border-primary/20200 dark:border-primary/20900 hover:border-primary/20400 dark:hover:border-primary/20700 transition-all duration-300 hover:shadow-xl">
                <div className="w-16 h-16 bg-gradient-to-br from-emerald-500 to-primary dark:primary dark:to-emerald-700 rounded-xl flex items-center justify-center mb-6 text-white shadow-lg group-hover:shadow-emerald-500/50 transition-shadow">
                  {benefit.icon}
                </div>
                <h3 className="text-xl font-bold mb-3 text-foreground group-hover:text-primary dark:group-hover:text-emerald-500 transition-colors">
                  {benefit.title}
                </h3>
