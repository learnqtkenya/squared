    ...
    <section id="portfolio" className="py-20 px-4 bg-gradient-to-br from-emerald-50 via-white to-emerald-50/30 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        <AnimatedSection className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">Case Study</h2>
        ...
        <AnimatedSection delay={0.2}>
          <div className="bg-background rounded-2xl p-8 md:p-10 border border-primary/20200 dark:border-primary/20900 shadow-xl hover:shadow-2xl transition-shadow duration-500">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              <div>
                ...
                <ul className="space-y-3 mb-8">
                  {features.map((feature, idx) => (
                    ...
                    >
                      <CheckCircle className="h-5 w-5 text-primary dark:text-emerald-500 flex-shrink-0 group-hover:scale-110 transition-transform" />
                ...
                >
                  <Link href={linkUrl}>
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="inline-flex items-center space-x-2 bg-gradient-to-r primary to-emerald-700 dark:from-emerald-700 dark:to-emerald-800 text-white px-8 py-3.5 rounded-lg hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 shadow-lg font-medium"
                    >
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute -inset-4 bg-gradient-to-r from-emerald-400 to-primary dark:primary dark:to-emerald-800 rounded-2xl opacity-20 blur-xl"></div>
