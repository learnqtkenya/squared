    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-emerald-200">
              <div className="space-y-6">
                <h3 className="text-2xl font-semibold mb-4 text-gray-800">Firmware Development Specializations</h3>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6 text-gray-900">Robust and Efficient Firmware Solutions</h2>
              ...
              <div className="bg-emerald-50 p-6 rounded-lg border border-emerald-200">
                <h4 className="font-semibold text-gray-900 mb-2">Our firmware development principles:</h4>
                <ul className="space-y-2">
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-600">Resource optimization for constrained environments</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-600">Robust error handling and fail-safe mechanisms</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <CheckCircle className="h-5 w-5 text-emerald-600 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-600">Clean, maintainable code architecture</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      {/* Expertise Section */}
      <section id="expertise" className="py-20 px-4 bg-emerald-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-center text-gray-900">Our Firmware Expertise</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 border border-emerald-100">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">Bare-metal Programming</h3>
              <p className="text-gray-600 mb-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-center space-x-2">
                  ...
                  <span className="text-gray-600">Optimized memory usage</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">Direct peripheral control</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">Deterministic execution</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 border border-emerald-100">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">RTOS-based Applications</h3>
              <p className="text-gray-600 mb-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">RTOS implementation</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">Task prioritization</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 border border-emerald-100">
              ...
              <h3 className="text-xl font-bold mb-4 text-gray-900">Power-Efficient Design</h3>
              <p className="text-gray-600 mb-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">Sleep mode optimization</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">Duty cycle management</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">Peripheral power control</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-12 grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 border border-emerald-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900">Secure Bootloaders & OTA Updates</h3>
              </div>
              <p className="text-gray-600 mb-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">Cryptographic signature verification</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">Failsafe recovery mechanisms</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">Multi-stage update process</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 border border-emerald-100">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-900">Communication Protocols</h3>
              </div>
              <p className="text-gray-600 mb-6">
              ...
              <ul className="space-y-2">
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">I2C, SPI, UART, CAN, USB implementations</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">RS485, ModBus, CANOpen, J1939, EtherCAT implementations</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">Custom protocol design</span>
                </li>
                <li className="flex items-center space-x-2">
                  <CheckCircle className="h-4 w-4 text-emerald-600 flex-shrink-0" />
                  <span className="text-gray-600">Wireless protocol stacks (BLE, LoRa, WiFi)</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-center text-gray-900">Supported Platforms</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6">
            {[
              ...
              <div key={platform.name} className="bg-white rounded-xl p-4 border border-emerald-100 flex flex-col items-center justify-center">
                <img
                  src={platform.logo}
      ...
      <section className="py-20 px-4 bg-emerald-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold mb-12 text-center text-gray-900">Featured Firmware Project</h2>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border border-emerald-200">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">ParcelPoint Smart Locker Firmware</h3>
                <p className="text-gray-600 mb-6">
      ...
      <section id="contact" className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Start Your Firmware Project</h2>
