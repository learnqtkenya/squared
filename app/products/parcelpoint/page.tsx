...
const ParcelPoint = () => {
  ...
  return (
    <div className="min-h-screen bg-background transition-colors duration-300">
      {/* Header */}
      <header className="py-4 px-4 sm:px-6 bg-background border-b border-primary/20100 dark:border-primary/20900/50">
        <div className="max-w-7xl mx-auto">
          <Link href="/" className="flex items-center gap-2 text-muted-foreground hover:text-primary dark:hover:text-emerald-500 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
          <div className="flex items-center justify-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-3xl text-foreground font-bold">ParcelPoint</span>
              <span className="text-sm tracking-widest text-primary dark:text-emerald-500">DROP • PAY • PICK</span>
            </div>
          </div>
        </div>
      </AnimatedSection>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 space-y-4">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center gap-3 bg-primary dark:bg-emerald-700 text-white px-8 py-4 rounded-lg hover:bg-emerald-700 dark:hover:bg-primary transition-all duration-300 shadow-lg font-medium text-lg"
                >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {features.map((feature, idx) => (
              <AnimatedCard key={idx} delay={idx * 0.1}>
                <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-primary/20200 dark:border-primary/20900/50 hover:border-primary/20400 dark:hover:border-primary/20600 transition-all duration-300 hover:shadow-xl h-full">
                  <div className="text-primary dark:text-emerald-500 mb-4">
                    {feature.icon}
                  </div>
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-20 bg-gradient-to-br primary to-emerald-700 dark:from-emerald-800 dark:to-emerald-900">
          ...
          <AnimatedSection>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-3 bg-white text-primary px-8 py-4 rounded-lg hover:bg-emerald-50 transition-all duration-300 shadow-xl font-semibold text-lg"
              >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-3 bg-emerald-800 dark:bg-emerald-700 text-white px-8 py-4 rounded-lg hover:bg-emerald-900 dark:hover:bg-primary transition-all duration-300 shadow-xl font-semibold text-lg"
              >
      ...
      <section className="py-16 sm:py-20 bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <AnimatedSection>
            <div className="bg-gradient-to-br from-gray-50 to-emerald-50/30 dark:from-gray-800 dark:to-emerald-950/20 rounded-2xl p-8 sm:p-12 border border-primary/20200 dark:border-primary/20900">
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="flex-1">
                  <div className="mb-3 inline-block px-4 py-1.5 bg-primary dark:bg-emerald-700 text-white rounded-full text-sm font-medium">
                    Technical Deep Dive
                  </div>
                  ...
                  <Link href="/case-studies/parcelpoint">
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="inline-flex items-center gap-2 bg-primary dark:bg-emerald-700 text-white px-6 py-3 rounded-lg hover:bg-emerald-700 dark:hover:bg-primary transition-all duration-300 shadow-lg font-medium"
                    >
