          ...
          <div className="grid md:grid-cols-3 gap-8">
            <AnimatedSection delay={0.1}>
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 hover:border-primary/20400 dark:hover:border-primary/20600 transition-all duration-300 hover:shadow-xl h-full">
                <div className="mb-6">
                  <h3 className="text-2xl font-bold mb-2 text-foreground">LVGL</h3>
                  <p className="text-sm text-primary dark:text-emerald-500 font-medium">For Resource-Constrained Systems</p>
                </div>
            ...
            <AnimatedSection delay={0.2}>
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 hover:border-primary/20400 dark:hover:border-primary/20600 transition-all duration-300 hover:shadow-xl h-full">
                <div className="mb-6">
                  <h3 className="text-2xl font-bold mb-2 text-foreground">Qt/QML</h3>
                  <p className="text-sm text-primary dark:text-emerald-500 font-medium">For Rich, High-Performance UIs</p>
                </div>
                <p className="text-muted-foreground mb-6">
            ...
            <AnimatedSection delay={0.3}>
              <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700 hover:border-primary/20400 dark:hover:border-primary/20600 transition-all duration-300 hover:shadow-xl h-full">
                <div className="mb-6">
                  ...
                  <p className="text-sm text-primary dark:text-emerald-500 font-medium">For Specialized Requirements</p>
                </div>
                <p className="text-muted-foreground mb-6">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              <AnimatedSection key={idx} delay={idx * 0.1}>
                <div className="bg-gradient-to-br from-emerald-50 to-white dark:from-gray-800 dark:to-gray-800/50 rounded-xl p-6 border border-primary/20200 dark:border-primary/20900/50 hover:border-primary/20400 dark:hover:border-primary/20700 transition-all duration-300 h-full">
                  <div className="text-3xl font-bold text-primary dark:text-emerald-500 mb-4">{phase.step}</div>
